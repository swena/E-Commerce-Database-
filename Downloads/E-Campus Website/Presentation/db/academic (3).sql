...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2013 at 09:12 AM
...
INSERT INTO `student` (`StudentID`, `Password`, `Name`, `ProgID`, `Batch`, `CPI`, `Blood_Group`, `Gender`, `Percentage`, `Name_Of_School`, `Board`, `Year`, `Height`, `IdentificationMark`, `Local_Address`, `Permanent_Address`, `Emergency_Address`) VALUES
('201001001', '123456', 'anurag singh', '1', 2010, 8.00, 'O -ve', 'F', 82, 'DPS School', 'CBSE', 2007, 6, ' ', 'Delhi', ' ', ' '),
('201001002', 'sandeep', 'sandeep mertia', '1', 2010, 7.00, ' ', ' ', 0, ' ', ' ', 0, 0, ' ', ' ', ' ', ' ');
