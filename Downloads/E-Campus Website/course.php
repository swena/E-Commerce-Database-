...
$semester_header =<<<EOD
 	<table align="center" bordercolordark="#0099FF" border="1" cellspacing="0" width="600px">
    	<tr>
        	<th id="sem1">Acad year</th>
            <th id="date1">Semester</th>
            <th id="submit1">Action</th>
        </tr>    
...
$semester_details .=<<<DET
		...
		<tr>
        	<td>$acad </td>
            <td>$sem1</td>
            <td submit="button"><fieldset><a href= "CourseAd.php?AcadYear=$acad&Semester=$sem1" class="button">VIEW</a> </fieldset></td>
        </tr>  
DET;
}
