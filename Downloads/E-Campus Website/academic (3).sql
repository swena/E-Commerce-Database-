...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2013 at 12:14 PM
...
INSERT INTO `admin` (`username`, `password`, `first_name`, `email`, `admin_level`, `id`) VALUES
('Sonu', 'sonu', 'Sonu', 'abc@gmail.com', 1, 1),
('anurag', 'anurag', 'anurag', 'abc1@gmail.com', 2, 2);
...
INSERT INTO `result` (`StudentID`, `AcadYear`, `Semester`, `credit_earn`, `grade_earn`, `Spi`) VALUES
('201001001', 2010, 'Autumn', 4, 11, 2.75),
('201001001', 2011, 'Autumn', 8, 22, 2.93),
('201001001', 2011, 'Winter', 3, 11, 3.67);
...
('201001001', '123456', 'anurag singh', '2013-02-24', '1', 2010, 8.00, 'O-ve', 'M', 82, 'DPS School', 'CBSE', 2008, 23, 'mole', 'Delhi', ' ', ' ', ''),
